...
impl<'de> Deserialize<'de> for BlobReference {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        let (specification_type, blob_reference_type) = match r.media_type.as_str() {
            ...
            other => return Err(D::Error::custom(format!("Invalid media type for BlobReference: {}", other))),
        };
...
impl<'de> Deserialize<'de> for Manifest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        let specification_type = match r.media_type.as_str() {
            ...
            other => return Err(D::Error::custom(format!("Invalid media type for Manifest: {}", other))),
        };
